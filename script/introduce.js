const major3Content = new Map([
  ...
  ["764", `<option value="al">Tất cả</option>`],
  [
    "772",
    `<option value="al">Tất cả</option>
...
const schoolNames = new Map([
  ["ANH", "HV An ninh Nhân dân"],
  ["ANS", "TĐH An ninh nhân dân"],
  ["BKA", "ĐH Bách khoa Hà Nội"],
  ["BMU", "TĐH Y dược Buôn Ma Thuột"],
  ["BPH", "HV Biên phòng"],
  ["BVH", "HV Công nghệ Bưu chính Viễn thông"],
  ["BVS", "HV Công nghệ Bưu chính Viễn thông - Cơ sở TP.HCM"],
  ["BVU", "TĐH Bà Rịa - Vũng Tàu"],
  ["CCM", "TĐH Công nghiệp Dệt may Hà Nội"],
  ["CEA", "TĐH Kinh tế Nghệ An"],
  ["CMC", "TĐH CMC"],
  ["CSH", "HV Cảnh sát Nhân dân"],
  ["CSS", "TĐH Cảnh sát nhân dân"],
  ["DAD", "TĐH Đông Á"],
  ["DBD", "TĐH Bình Dương"],
  ["DBG", "TĐH Nông Lâm Bắc Giang"],
  ["DBH", "TĐH Quốc tế Bắc Hà"],
  ["DBL", "TĐH Bạc Liêu"],
  ["DCA", "TĐH Chu Văn An"],
  ["DCD", "TĐH Công nghệ Đồng Nai"],
  ["DCH", "Trường Sĩ quan Đặc công"],
  ["DCL", "TĐH Cửu Long"],
  ["DCN", "TĐH Công nghiệp Hà Nội"],
  ["DCQ", "TĐH Công nghệ và Quản lý Hữu nghị"],
  ["DCT", "TĐH Công thương TP.HCM"],
  ["DCV", "TĐH Công nghiệp Vinh"],
  ["DDA", "TĐH Công nghệ Đông Á"],
  ["DDB", "TĐH Thành Đông"],
  ["DDF", "TĐH Ngoại ngữ, ĐH Đà Nẵng"],
  ["DDG", "Khoa Giáo dục Thể chất, ĐH Đà Nẵng"],
  ["DDK", "TĐH Bách Khoa, ĐH Đà Nẵng"],
  ["DDL", "TĐH Điện lực"],
  ["DDM", "TĐH Công nghiệp Quảng Ninh"],
  ["DDN", "TĐH Đại Nam"],
  ["DDP", "Phân hiệu ĐH Đà Nẵng tại Kon Tum"],
  ["DDQ", "TĐH Kinh tế, ĐH Đà Nẵng"],
  ["DDS", "TĐH Sư phạm, ĐH Đà Nẵng"],
  ["DDT", "TĐH Duy Tân"],
  ["DDU", "TĐH Đông Đô"],
  ["DDV", "Viện nghiên cứu đào tạo Việt - Anh, ĐH Đà Nẵng"],
  ["DDY", "Khoa Y Dược, ĐH Đà Nẵng"],
  ["DFA", "TĐH Tài chính - Quản trị kinh doanh"],
  ["DHA", "TĐH Luật, ĐH Huế"],
  ["DHC", "Khoa Giáo dục Thể chất, ĐH Huế"],
  ["DHD", "Trường Du lịch, ĐH Huế"],
  ["DHE", "Khoa Kỹ thuật và công nghệ, ĐH Huế"],
  ["DHF", "TĐH Ngoại ngữ, ĐH Huế"],
  ["DHI", "Khoa Quốc tế, ĐH Huế"],
  ["DHK", "TĐH Kinh tế, ĐH Huế"],
  ["DHL", "TĐH Nông Lâm, ĐH Huế"],
  ["DHN", "TĐH Nghệ thuật, ĐH Huế"],
  ["DHP", "TĐH Quản lý và công nghệ Hải Phòng"],
  ["DHQ", "Phân hiệu ĐH Huế tại quảng Trị"],
  ["DHS", "TĐH Sư phạm, ĐH Huế"],
  ["DHT", "TĐH Khoa học, ĐH Huế"],
  ["DHV", "TĐH Hùng Vương TPHCM"],
  ["DHY", "TĐH Y Dược, ĐH Huế"],
  ["DKB", "TĐH Kinh tế Kỹ thuật Bình Dương"],
  ["DKC", "TĐH Công nghệ TP.HCM"],
  ["DKH", "TĐH Dược Hà Nội"],
  ["DKK", "TĐH Kinh tế Kỹ thuật Công nghiệp"],
  ["DKS", "TĐH Kiểm sát Hà Nội"],
  ["DKT", "TĐH Hải Dương"],
  ["DKY", "TĐH Kỹ thuật Y tế Hải Dương"],
  ["DLA", "TĐH Kinh tế - Công nghiệp Long An"],
  ["DLH", "TĐH Lạc Hồng"],
  ["DLS", "TĐH Lao động Xã hội - Cơ sở TP.HCM"],
  ["DLX", "TĐH Lao động Xã hội"],
  ["DMS", "TĐH Tài chính - Marketing"],
  ["DMT", "TĐH Tài nguyên và Môi trường Hà Nội"],
  ["DNB", "TĐH Hoa Lư"],
  ["DNC", "TĐH Nam Cần Thơ"],
  ["DNT", "TĐH Ngoại ngữ - Tin học TP.HCM"],
  ["DNU", "TĐH Đồng Nai"],
  ["DPC", "TĐH Phan Châu Trinh"],
  ["DPD", "TĐH Phương Đông"],
  ["DPQ", "TĐH Phạm Văn Đồng"],
  ["DPT", "TĐH Phan Thiết"],
  ["DPX", "TĐH Dân lập Phú Xuân"],
  ["DPY", "TĐH Phú Yên"],
  ["DQB", "TĐH Quảng Bình"],
  ["DQK", "TĐH Kinh doanh và Công nghệ Hà Nội"],
  ["DQN", "TĐH Quy Nhơn"],
  ["DQT", "TĐH Quang Trung"],
  ["DQU", "TĐH Quảng Nam"],
  ["DSD", "TĐH Sân khấu Điện ảnh TP.HCM"],
  ["DSG", "TĐH Công nghệ Sài Gòn"],
  ["DSK", "TĐH Sư phạm Kỹ thuật, ĐH Đà Nẵng"],
  ["DTB", "TĐH Thái Bình"],
  ["DTC", "TĐH Công nghệ thông tin và Truyền thông, ĐH Thái Nguyên"],
  ["DTD", "TĐH Tây Đô"],
  ["DTE", "TĐH Kinh tế - Quản trị kinh doanh, ĐH Thái Nguyên"],
  ["DTF", "Trường Ngoại ngữ, ĐH Thái Nguyên"],
  ["DTK", "TĐH Kỹ thuật Công nghiệp, ĐH Thái Nguyên"],
  ["DTL", "TĐH Thăng Long"],
  ["DTM", "TĐH Tài nguyên và Môi trường TP.HCM"],
  ["DTN", "TĐH Nông lâm, ĐH Thái Nguyên"],
  ["DTP", "Phân hiệu ĐH Thái Nguyên tại Lào Cai"],
  ["DTQ", "Khoa Quốc tế, ĐH Thái Nguyên"],
  ["DTS", "TĐH Sư phạm, ĐH Thái Nguyên"],
  ["DTT", "TĐH Tôn Đức Thắng"],
  ["DTV", "TĐH Lương Thế Vinh"],
  ["DTY", "TĐH Y Dược, ĐH Thái Nguyên"],
  ["DTZ", "TĐH Khoa học, ĐH Thái Nguyên"],
  ["DVB", "TĐH Việt Bắc"],
  ["DVD", "TĐH Văn hóa Thể thao và Du lịch Thanh Hóa"],
  ["DVH", "TĐH Văn Hiến"],
  ["DVL", "TĐH Văn Lang"],
  ["DVP", "TĐH Trưng Vương"],
  ["DVT", "TĐH Trà Vinh"],
  ["DVX", "TĐH Công nghệ Vạn Xuân"],
  ["DYD", "TĐH Yersin Đà Lạt"],
  ["EIU", "TĐH Quốc tế Miền Đông"],
  ["ETU", "TĐH Hòa Bình"],
  ["FBU", "TĐH Tài chính Ngân hàng Hà Nội"],
  ["FPT", "TĐH FPT"],
  ["GDU", "TĐH Gia Định"],
  ["GHA", "TĐH Giao thông vận tải"],
  ["GNT", "TĐH Sư phạm Nghệ thuật Trung ương Hà Nội"],
  ["GSA", "TĐH Giao thông vận tải - Cơ sở 2"],
  ["GTA", "TĐH Công nghệ Giao thông vận tải"],
  ["GTS", "TĐH Giao thông vận tải TP.HCM"],
  ["HBT", "HV Báo chí Tuyên truyền"],
  ["HCA", "HV Chính trị Công an Nhân dân"],
  ["HCB", "TĐH Kỹ thuật - Hậu cần Công an nhân dân phía Bắc"],
  ["HCH", "HV Hành chính Quốc gia"],
  ["HCN", "TĐH Kỹ thuật - Hậu cần Công an nhân dân phía Nam"],
  ["HCP", "HV Chính sách và Phát triển"],
  ["HDT", "TĐH Hồng Đức"],
  ["HEH", "HV Hậu cần"],
  ["HGH", "Trường Sĩ quan Phòng Hóa"],
  ["HHA", "TĐH Hàng hải"],
  ["HHK", "HV Hàng không Việt Nam"],
  ["HHT", "TĐH Hà Tĩnh"],
  ["HIU", "TĐH Quốc tế Hồng Bàng"],
  ["HLU", "TĐH Hạ Long"],
  ["HNM", "TĐH Thủ đô Hà Nội"],
  ["HPN", "HV Phụ nữ Việt Nam"],
  ["HQH", "HV Hải Quân"],
  ["HQT", "HV Ngoại giao"],
  ["HSU", "TĐH Hoa Sen"],
  ["HTA", "HV Tòa án"],
  ["HTC", "HV Tài chính"],
  ["HTN", "HV Thanh Thiếu niên Việt Nam"],
  ["HVA", "HV Âm nhạc Huế"],
  ["HVC", "HV Cán bộ TP.HCM"],
  ["HVN", "HV Nông nghiệp Việt Nam"],
  ["HVQ", "HV Quản lý Giáo dục"],
  ["HYD", "HV Y - Dược học cổ truyền Việt Nam"],
  ["IUH", "TĐH Công nghiệp TP.HCM"],
  ["KCC", "TĐH Kỹ thuật Công nghệ Cần Thơ"],
  ["KCN", "TĐH Khoa học và Công nghệ Hà Nội"],
  ["KGH", "Trường Sĩ quan không quân"],
  ["KHA", "TĐH Kinh tế Quốc dân"],
  ["KMA", "HV Kỹ thuật Mật mã"],
  ["KQH", "HV Kỹ thuật Quân sự"],
  ["KSA", "TĐH Kinh tế TP.HCM"],
  ["KTA", "TĐH Kiến trúc Hà Nội"],
  ["KTD", "TĐH Kiến trúc Đà Nẵng"],
  ["KTS", "TĐH Kiến trúc TP.HCM"],
  ["LAH", "Trường Sĩ quan Lục quân 1 (ĐH Trần Quốc Tuấn)"],
  ["LBH", "Trường Sĩ quan Lục quân 2 (ĐH Nguyễn Huệ)"],
  ["LCH", "TĐH Chính trị (Trường Sĩ quan Chính trị)"],
  ["LDA", "TĐH Công đoàn"],
  ["LNH", "TĐH Lâm nghiệp"],
  ["LNS", "TĐH Lâm nghiệp - Cơ sở 2"],
  ["LPH", "TĐH Luật Hà Nội"],
  ["LPS", "TĐH Luật TP.HCM"],
  ["MBS", "TĐH Mở TP.HCM "],
  ["MDA", "TĐH Mỏ Địa chất Hà Nội"],
  ["MHN", "TĐH Mở Hà Nội"],
  ["MIT", "TĐH Công nghệ Miền Đông"],
  ["MTC", "TĐH Mỹ thuật Công nghiệp"],
  ["MTH", "TĐH Mỹ thuật Việt Nam"],
  ["MTS", "TĐH Mỹ thuật TP.HCM"],
  ["MTU", "TĐH Xây dựng Miền Tây"],
  ["NHF", "TĐH Hà Nội"],
  ["NHH", "HV Ngân hàng"],
  ["NHS", "TĐH Ngân hàng TP.HCM"],
  ["NLS", "TĐH Nông Lâm TP.HCM"],
  ["NQH", "HV Khoa học Quân sự"],
  ["NTH", "TĐH Ngoại thương"],
  ["NTS", "TĐH Ngoại thương - Cơ sở phía Nam"],
  ["NTT", "TĐH Nguyễn Tất Thành"],
  ["NTU", "TĐH Nguyễn Trãi"],
  ["NVH", "HV Âm nhạc Quốc gia Việt Nam"],
  ["NVS", "Nhạc viện TP.HCM"],
  ["PBH", "Trường Sĩ quan Pháo binh"],
  ["PCH", "TĐH Phòng cháy chữa cháy phía Bắc"],
  ["PCS", "TĐH Phòng cháy chữa cháy phía Nam"],
  ["PKA", "TĐH Phenikaa"],
  ["PKH", "HV Phòng không - Không quân"],
  ["PVU", "TĐH Dầu khí Việt Nam"],
  ["QHD", "Trường Quản trị và kinh doanh, ĐH Quốc gia Hà Nội"],
  ["QHE", "TĐH Kinh tế, ĐH Quốc gia Hà Nội"],
  ["QHF", "TĐH Ngoại ngữ, ĐH Quốc gia Hà Nội"],
  ["QHI", "TĐH Công nghệ, ĐH Quốc gia Hà Nội"],
  ["QHL", "TĐH Luật, ĐH Quốc gia Hà Nội"],
  ["QHQ", "Trường Quốc tế, ĐH Quốc gia Hà Nội"],
  ["QHS", "TĐH Giáo dục, ĐH Quốc gia Hà Nội"],
  ["QHT", "TĐH Khoa học tự nhiên, ĐH Quốc gia Hà Nội"],
  ["QHX", "TĐH Khoa học Xã hội và Nhân văn, ĐH Quốc gia Hà Nội"],
  ["QHY", "TĐH Y Dược, ĐH Quốc gia Hà Nội"],
  ["QSB", "TĐH Bách Khoa, ĐH Quốc gia TP.HCM"],
  ["QSC", "TĐH Công nghệ thông tin, ĐH Quốc gia TP.HCM"],
  ["QSK", "TĐH Kinh tế - Luật, ĐH Quốc gia TP.HCM"],
  ["QSQ", "TĐH Quốc tế, ĐH Quốc gia TP.HCM"],
  ["QST", "TĐH Khoa học tự nhiên, ĐH Quốc gia TP.HCM"],
  ["QSX", "TĐH Khoa học xã hội và Nhân văn, ĐH Quốc gia TP.HCM"],
  ["QSY", "TĐH Khoa học sức khỏe, ĐH Quốc gia TP.HCM"],
  ["SDU", "TĐH Sao Đỏ"],
  ["SGD", "TĐH Sài Gòn"],
  ["SIU", "TĐH Quốc tế Sài Gòn"],
  ["SKD", "TĐH Sân khấu Điện ảnh"],
  ["SKH", "TĐH Sư phạm Kỹ thuật Hưng Yên"],
  ["SKN", "TĐH Sư phạm Kỹ thuật Nam Định"],
  ["SKV", "TĐH Sư phạm Kỹ thuật Vinh"],
  ["SNH", "Trường Sĩ quan Công binh"],
  ["SP2", "TĐH Sư phạm Hà Nội 2"],
  ["SPD", "TĐH Đồng Tháp"],
  ["SPH", "TĐH Sư phạm Hà Nội"],
  ["SPK", "TĐH Sư phạm Kỹ thuật TP.HCM"],
  ["SPS", "TĐH Sư phạm TP.HCM"],
  ["STS", "TĐH Sư phạm Thể dục thể thao TP. HCM"],
  ["TAG", "TĐH An Giang, ĐH Quốc gia TP.HCM"],
  ["TBD", "TĐH Thái Bình Dương"],
  ["TCT", "ĐH Cần Thơ"],
  ["TDB", "TĐH Thể dục Thể thao Bắc Ninh"],
  ["TDD", "TĐH Thành Đô"],
  ["TDH", "TĐH Sư phạm Thể dục thể thao Hà nội"],
  ["TDL", "TĐH Đà Lạt"],
  ["TDM", "TĐH Thủ Dầu Một"],
  ["TDS", "TĐH Thể dục Thể thao TP.HCM"],
  ["TDV", "TĐH Vinh"],
  ["TGH", "Trường Sĩ quan Tăng - Thiết giáp"],
  ["THP", "TĐH Hải Phòng"],
  ["THU", "TĐH Y khoa Tokyo Việt Nam"],
  ["THV", "TĐH Hùng Vương"],
  ["TKG", "TĐH Kiên Giang"],
  ["TLA", "TĐH Thủy lợi"],
  ["TLS", "TĐH Thủy lợi - Cơ sở 2"],
  ["TMU", "TĐH Thương mại"],
  ["TQU", "TĐH Tân Trào"],
  ["TSN", "TĐH Nha Trang"],
  ["TTB", "TĐH Tây Bắc"],
  ["TTD", "TĐH Thể dục Thể thao Đà Nẵng"],
  ["TTG", "TĐH Tiền Giang"],
  ["TTH", "Trường Sĩ quan Thông tin"],
  ["TTN", "TĐH Tây Nguyên"],
  ["TTU", "TĐH Tân Tạo"],
  ["TYS", "TĐH Y khoa Phạm Ngọc Thạch"],
  ["UEF", "TĐH Kinh tế - Tài chính TP.HCM"],
  ["UFA", "TĐH Tài chính Kế toán"],
  ["UKB", "TĐH Kinh Bắc"],
  ["UKH", "TĐH Khánh Hòa"],
  ["UMT", "TĐH Quản lý và công nghệ TPHCM"],
  ["VGU", "TĐH Việt - Đức"],
  ["VHD", "TĐH Công nghiệp Việt Hung"],
  ["VHH", "TĐH Văn hóa Hà Nội"],
  ["VHS", "TĐH Văn hóa TP.HCM"],
  ["VJU", "TĐH Việt Nhật, ĐH Quốc gia Hà Nội"],
  ["VKU", "Khoa Công nghệ thông tin và Truyền thông, ĐH Đà Nẵng"],
  ["VLU", "TĐH Sư phạm Kỹ thuật Vĩnh Long"],
  ["VPH", "Trường Sĩ quan Kỹ thuật Quân sự Vinhempich (ĐH Trần Đại Nghĩa)  "],
  ["VTT", "TĐH Võ Trường Toản"],
  ["VUI", "TĐH Công nghiệp Việt Trì"],
  ["XDA", "TĐH Xây dựng Hà Nội"],
  ["XDT", "TĐH Xây dựng Miền Trung"],
  ["YCT", "TĐH Y Dược Cần Thơ"],
  ["YDD", "TĐH Điều dưỡng Nam Định"],
  ["YDN", "TĐH Kỹ thuật Y Dược Đà Nẵng"],
  ["YDS", "TĐH Y Dược TP.HCM"],
  ["YHB", "TĐH Y Hà Nội"],
  ["YKV", "TĐH Y khoa Vinh"],
  ["YPB", "TĐH Y Dược Hải Phòng"],
  ["YQH", "HV Quân Y"],
  ["YTB", "TĐH Y Dược Thái Bình"],
  ["YTC", "TĐH Y tế Công cộng"],
  ["ZNH", "TĐH Văn hóa - Nghệ thuật Quân đội"],
]);

import { showLoading, hideLoading } from "./loading.js";

import { getGroupName } from "./score_convert_model.js";
...
document.addEventListener("DOMContentLoaded", (event) => {
  ...
  let major1 = document.getElementById("major-1-id");
  let major3 = document.getElementById("major-3-id");

  major1.addEventListener("change", (event) => {
    // alert(major3Content[Number(major1.value)]);
    major3.innerHTML = major3Content.get(major1.value);
  });

  major1.dispatchEvent(new Event("change"));
  ...
  document.getElementById("search-btn").addEventListener("click", async () => {
    ...
    function updateChart(chart, labels, datas) {
    ...
    updateChart(
      ...
      groups
        .map((item) => item.id)
        .map((group) => (group == "Khác" ? "Khác" : getGroupName(group))),
      groups.map((item) => item.quan)
    );
